...
int dwc_umctl2_init(unsigned int dram_id)
{
	...
	//RESET:<presetn> ASSERTED (ACTIVE LOW) 
	//RESET:<presetn> DEASSERTED 
	UMCTL2_REG(0x0304) = UMCTL2_304(UMCTL2_304_5);
	UMCTL2_REG(0x0030) = UMCTL2_30(UMCTL2_30_1); //PWRCTL	
	UMCTL2_REG(0x0004); //STAT			
	UMCTL2_REG(0x0000) = UMCTL2_0;//MSTR	
	UMCTL2_REG(0x0010) = UMCTL2_10; //MRCTRL0								
	UMCTL2_REG(0x0014) = UMCTL2_14; //MRCTRL1								
	UMCTL2_REG(0x001c) = UMCTL2_1C; //MRCTRL2	
	UMCTL2_REG(0x0020) = UMCTL2_20; //DERATEEN								
	UMCTL2_REG(0x0024) = UMCTL2_24; //DERATEINT 							
	UMCTL2_REG(0x002c) = UMCTL2_2C; //DERATECTL 							
	UMCTL2_REG(0x0030) = UMCTL2_30(UMCTL2_30_2); //PWRCTL								
	UMCTL2_REG(0x0034) = UMCTL2_34; //PWRTMG								
	UMCTL2_REG(0x0038) = UMCTL2_38; //HWLPCTL								
	UMCTL2_REG(0x0050) = UMCTL2_50; //RFSHCTL0	
	UMCTL2_REG(0x0060) = UMCTL2_60; //RFSHCTL3								
	UMCTL2_REG(0x0064) = UMCTL2_64; //RFSHTMG	
	UMCTL2_REG(0x0068) = UMCTL2_68; //RFSHTMG1	
	UMCTL2_REG(0x00c0) = UMCTL2_C0; //CRCPARCTL0								
	UMCTL2_REG(0x00c4) = UMCTL2_C4(UMCTL2_C4_1);	//CRCPARCTL1
	UMCTL2_REG(0x00d0) = UMCTL2_D0; //INIT0 							
	UMCTL2_REG(0x00d4) = UMCTL2_D4; //INIT1 							
	UMCTL2_REG(0x00d8) = UMCTL2_D8; //INIT2 							
	UMCTL2_REG(0x00dc) = UMCTL2_DC; //INIT3
	UMCTL2_REG(0x00e0) = UMCTL2_E0; //INIT4 							
	UMCTL2_REG(0x00e4) = UMCTL2_E4; //INIT5 							
	UMCTL2_REG(0x00e8) = UMCTL2_E8; //INIT6 							
	UMCTL2_REG(0x00ec) = UMCTL2_EC; //INIT7 
	UMCTL2_REG(0x00f0) = UMCTL2_F0; //DIMMCTL
	UMCTL2_REG(0x0100) = UMCTL2_100;	//DRAMTMG0								
	UMCTL2_REG(0x0104) = UMCTL2_104;	//DRAMTMG1								
	UMCTL2_REG(0x0108) = UMCTL2_108;	//DRAMTMG2								
	UMCTL2_REG(0x010c) = UMCTL2_10C;	//DRAMTMG3	
	UMCTL2_REG(0x0110) = UMCTL2_110;	//DRAMTMG4								
	UMCTL2_REG(0x0114) = UMCTL2_114;	//DRAMTMG5								
	UMCTL2_REG(0x0118) = UMCTL2_118;	//DRAMTMG6								
	UMCTL2_REG(0x011c) = UMCTL2_11C;	//DRAMTMG7								
	UMCTL2_REG(0x0120) = UMCTL2_120;	//DRAMTMG8								
	UMCTL2_REG(0x0124) = UMCTL2_124;	//DRAMTMG9								
	UMCTL2_REG(0x0128) = UMCTL2_128;	//DRAMTMG10 							
	UMCTL2_REG(0x012c) = UMCTL2_12C;	//DRAMTMG11 							
	UMCTL2_REG(0x0130) = UMCTL2_130;	//DRAMTMG12 							
	UMCTL2_REG(0x0134) = UMCTL2_134;	//DRAMTMG13 							
	UMCTL2_REG(0x0138) = UMCTL2_138;	//DRAMTMG14 							
	UMCTL2_REG(0x013c) = UMCTL2_13C;	//DRAMTMG15 
	UMCTL2_REG(0x0180) = UMCTL2_180;	//ZQCTL0								
	UMCTL2_REG(0x0184) = UMCTL2_184;	//ZQCTL1								
	UMCTL2_REG(0x0188) = UMCTL2_188;	//ZQCTL2	
	UMCTL2_REG(0x0190) = UMCTL2_190;	//DFITMG0								
	UMCTL2_REG(0x0194) = UMCTL2_194;	//DFITMG1								
	UMCTL2_REG(0x0198) = UMCTL2_198;	//DFILPCFG0 							
	UMCTL2_REG(0x019c) = UMCTL2_19C;	//DFILPCFG1 
	UMCTL2_REG(0x01a0) = UMCTL2_1A0;	//DFIUPD0								
	UMCTL2_REG(0x01a4) = UMCTL2_1A4;	//DFIUPD1								
	UMCTL2_REG(0x01a8) = UMCTL2_1A8;	//DFIUPD2								
	UMCTL2_REG(0x01b0) = UMCTL2_1B0(UMCTL2_1B0_1);	//DFIMISC								
	UMCTL2_REG(0x01b4) = UMCTL2_1B4;	//DFITMG2								
	UMCTL2_REG(0x01b8) = UMCTL2_1B8;	//DFITMG3								
	UMCTL2_REG(0x01c0) = UMCTL2_1C0;	//DBICTL								
	UMCTL2_REG(0x01c4) = UMCTL2_1C4(UMCTL2_1C4_1);	//DFIPHYMSTR	
	UMCTL2_REG(0x0204) = UMCTL2_204;	//ADDRMAP1								
	UMCTL2_REG(0x0208) = UMCTL2_208;	//ADDRMAP2								
	UMCTL2_REG(0x020c) = UMCTL2_20C;	//ADDRMAP3	
	UMCTL2_REG(0x0210) = UMCTL2_210;	//ADDRMAP4								
	UMCTL2_REG(0x0214) = UMCTL2_214;	//ADDRMAP5									
	UMCTL2_REG(0x0218) = UMCTL2_218;	//ADDRMAP6								
	UMCTL2_REG(0x021c) = UMCTL2_21C;	//ADDRMAP7	
	UMCTL2_REG(0x0220) = UMCTL2_220;	//ADDRMAP8								
	UMCTL2_REG(0x0224) = UMCTL2_224;	//ADDRMAP9								
	UMCTL2_REG(0x0228) = UMCTL2_228;	//ADDRMAP10 							
	UMCTL2_REG(0x022c) = UMCTL2_22C;	//ADDRMAP11 							
	UMCTL2_REG(0x0240) = UMCTL2_240;	//ODTCFG								
	UMCTL2_REG(0x0244) = UMCTL2_244;	//ODTMAP	
	UMCTL2_REG(0x0250) = UMCTL2_250;	//SCHED 							
	UMCTL2_REG(0x0254) = UMCTL2_254;	//SCHED1								
	UMCTL2_REG(0x025c) = UMCTL2_25C;	//PERFHPR1								
	UMCTL2_REG(0x0264) = UMCTL2_264;	//PERFLPR1								
	UMCTL2_REG(0x026c) = UMCTL2_26C;	//PERFWR1	
	UMCTL2_REG(0x0300) = UMCTL2_300;	//DBG0								
	UMCTL2_REG(0x0304) = UMCTL2_304(UMCTL2_304_3);	//DBG1								
	UMCTL2_REG(0x030c) = UMCTL2_30C;	//DBGCMD								
	UMCTL2_REG(0x0320) = UMCTL2_320(UMCTL2_320_1);	//SWCTL 							
	UMCTL2_REG(0x0328) = UMCTL2_328;	//SWCTLSTATIC	
	UMCTL2_REG(0x036c) = UMCTL2_36C;	//POISONCFG 							
	UMCTL2_REG(0x0400) = UMCTL2_400;	//PCCFG 							
	UMCTL2_REG(0x0404) = UMCTL2_404;	//PCFGR_0								
	UMCTL2_REG(0x0408) = UMCTL2_408(UMCTL2_408_4);	//PCFGW_0	
	UMCTL2_REG(0x0490) = UMCTL2_490;	//PCTRL_0								
	UMCTL2_REG(0x0494) = UMCTL2_494;	//PCFGQOS0_0								
	UMCTL2_REG(0x0498) = UMCTL2_498;	//PCFGQOS1_0								
	UMCTL2_REG(0x049c) = UMCTL2_49C;	//PCFGWQOS0_0								
	UMCTL2_REG(0x04a0) = UMCTL2_4A0;	//PCFGWQOS1_0	
	UMCTL2_REG(0x0060); 								
	UMCTL2_REG(0x0030); 	//PWRCTL							
	UMCTL2_REG(0x0030) = UMCTL2_30(UMCTL2_30_2); //PWRCTL 
	//RESET:<aresetn> for Port 0 DEASSERTED 
	//RESET:<core_ddrc_rstn> DEASSERTED 
	UMCTL2_REG(0x0304) = UMCTL2_304(UMCTL2_304_3);
	UMCTL2_REG(0x0030); 	//PWRCTL		
	UMCTL2_REG(0x0030) = UMCTL2_30(UMCTL2_30_2); //PWRCTL 
	UMCTL2_REG(0x0030); 	//PWRCTL		
	UMCTL2_REG(0x0030) = UMCTL2_30(UMCTL2_30_2); //PWRCTL 
	UMCTL2_REG(0x01c4); //DFIPHYMSTR	
	UMCTL2_REG(0x01c4) = UMCTL2_1C4(UMCTL2_1C4_2);	//DFIPHYMSTR	
	UMCTL2_REG(0x0320) = UMCTL2_320(UMCTL2_304_2);	//SWCTL 	
	UMCTL2_REG(0x01b0) = UMCTL2_1B0(UMCTL2_1B0_2);	//DFIMISC
	UMCTL2_REG(0x01b0) = UMCTL2_1B0(UMCTL2_1B0_2);	//DFIMISC
	UMCTL2_REG(0x0304) = UMCTL2_304(UMCTL2_304_4);
#endif 
#if 0
