...
#define SAFE_MARGIN_VALUE 215 	//need modify
#define IPRD_VALUE 535			//need modify
...
// - Q645 can support DRAM-speed from LPDDR4-3200
//   #1. LPDDR4-3200		: [#define SDRAM_SPEED_1600]
// -----------------------------------------------------------------
#ifdef          MPEG_DRAM_DDR_3200
...
// --- IO Impedance ---
#ifdef	MPEG_DRAM_TYPE_DDR4  //need modify
// DDR4 setting
// RTT-value
#define DDR4_RTT_120
// #define DDR4_RTT_60
...
#elif defined  MPEG_DRAM_TYPE_DDR3
// DDR3 setting
// RTT-value
#define DDR3_RTT_120
// #define DDR3_RTT_60
...
// =============================================================================
#ifdef MPEG_DRAM_TYPE_DDR4
#define nDDR_TYPE       4    //need modify
#elif definded MPEG_DRAM_TYPE_DDR3
#define nDDR_TYPE       3
#else
// DDR2
#define nDDR_TYPE       2
...
#ifdef SDRAM1_SIZE_4Gb	//need modify
...
#define DPCU_CL_M2                      // MR0 CL_M2 = 1
#elif defined(SDRAM_SPEED_1600)
#define n_tCL           14              // 14T -- Case latency (set to mrs)   //need modify
#define DPCU_CL_M2                      // MR0 CL_M2 = 1	//need modify
...
#elif defined SDRAM_SPEED_1600
//LPDDR4-1600
#define MRS_CWL_CNT     9	//need modify
...
#define MRS_WR_GEN2
#endif //endif - SDRAM_SPEED_1600
#endif // endif - MPEG_DRAM_TYPE_DDR4
...
#elif defined SDRAM_SPEED_1600  //need modify
#define nAREF_ACC      0
#define nAREF_INTVAL   390
#ifdef SDRAM_SIZE_4Gb
#define n_tRFC  (144  + DRAM_PARAMETER_OFFSET)
...
// Mode 0
#if defined(SDRAM_SPEED_1600) //need modify
...
#define UMCTL2_10       0x4000c010

#define UMCTL2_14       0x000209ce

#define UMCTL2_1C       0xe7256067

#define UMCTL2_20       0x00001203

#define UMCTL2_24       0x031cd8cf

#define UMCTL2_2C       0x00000000

#define UMCTL2_30_1     1
#define UMCTL2_30_2     0x120
#define UMCTL2_30(n)    ((n) << 0)



#define UMCTL2_34_1     4
#define UMCTL2_34_2     6
#define UMCTL2_34       ((UMCTL2_34_1)  << 16 |\
                         (UMCTL2_34_2)  <<  8 )

#define UMCTL2_38_1             0
...
#define UMCTL2_50_1     10
#define UMCTL2_50_2     8
#define UMCTL2_50_3     15
#define UMCTL2_50_4     1
...
#define UMCTL2_D4_2     6
#define UMCTL2_D4       ((UMCTL2_D4_1)  << 16 |\
                         (UMCTL2_D4_2)  <<  0 )

#define UMCTL2_D8_1     69
#define UMCTL2_D8_2     5
#define UMCTL2_D8       ((UMCTL2_D8_1)  << 8 |\
                         (UMCTL2_D8_2)  <<  0 )
...
#define UMCTL2_204_3    (nCOL_WIDTH + 3)
#define UMCTL2_204      ((UMCTL2_204_1) << 16 |\
        ...
        #define UMCTL2_20C_1    2
        #define UMCTL2_20C_2    1
        #define UMCTL2_20C_3    0
        #define UMCTL2_20C_4    0
        #define UMCTL2_208_1    0
        #define UMCTL2_208_2    0
...
#define UMCTL2_22C      ((UMCTL2_22C_2) << 16 |\
                         ...
                         (UMCTL2_22C_1) <<  0 )
#else
#define UMCTL2_224	0x09070904

#define UMCTL2_228	0x0b030901

#define UMCTL2_22C	0x00000009
#endif

#if 0
#define UMCTL2_240_1    14
#define UMCTL2_240_2    29
...
#define UMCTL2_250_1    72
#define UMCTL2_250_2    247
#define UMCTL2_250_3    154
#define UMCTL2_250_4    1
#define UMCTL2_250_5    1
#define UMCTL2_250_6    0
...
#define UMCTL2_254_1    48
#define UMCTL2_254      ((UMCTL2_254_1) << 0 )

#define UMCTL2_25C_1    13
...
#define UMCTL2_26C_1    66
#define UMCTL2_26C_2    22860
...
#define UMCTL2_494	0x00210002

#define UMCTL2_498	0x00e702d6

#define UMCTL2_49C	0x01100c01

#define UMCTL2_4A0	0x02af028c
